...
import {
  MethodFind,
  MethodReplaceCollection,
  MethodAddToCollection,
  MethodSum,
  MethodStream,
  MethodValidate,
  MethodFindOne,
  MethodFindOrCreate,
  MethodRemoveFromCollection,
  MethodDestroy,
  MethodCreateEach
} from './methods/index';
...
class MetaModel {
  ...
  constructor(orm: any, adapterWrapper: any) {
  ...
  public static extend(protoProps, staticProps) {
  ...
  public find(criteria?, populates?, explicitCbMaybe?, meta?) {
    MethodFind.execute(this, criteria, populates, explicitCbMaybe, meta);
  }

  public addToCollection(targetRecordIds, collectionAttrName, associatedIds?, explicitCbMaybe?, meta?) {
    MethodAddToCollection.execute(this, targetRecordIds, collectionAttrName, associatedIds, explicitCbMaybe, meta);
  }
  public sum(numericAttrName?, criteria?, explicitCbMaybe?, meta?, moreQueryKeys?) {
    MethodAddToCollection.execute(this, numericAttrName, criteria, explicitCbMaybe, meta, moreQueryKeys);
  }

  public findOne(criteria?, populates?, explicitCbMaybe?, meta?) {
    MethodFindOne.execute(this, criteria, populates, explicitCbMaybe, meta);
  }


  public findOrCreate(criteria?, newRecord?, explicitCbMaybe?, meta?) {
    MethodFindOrCreate.execute(this, criteria, newRecord, explicitCbMaybe, meta);
  }
  public stream() {
    MethodFindOne.execute(this, );
  }
  ...
  public createEach(newRecords?, explicitCbMaybe?, meta?) {
    MethodCreateEach.execute(this, newRecords, explicitCbMaybe, meta);
  }
  ...
  public destroy(criteria, explicitCbMaybe, metaContainer) {
    MethodDestroy.execute(this, criteria, explicitCbMaybe, metaContainer);
  }


  public removeFromCollection(targetRecordIds?, collectionAttrName?, associatedIds?, explicitCbMaybe?, meta?) {
    MethodRemoveFromCollection.execute(this, targetRecordIds, collectionAttrName, associatedIds, explicitCbMaybe, meta);
  }


  public replaceCollection(targetRecordIds?, collectionAttrName?, associatedIds?, explicitCbMaybe?, meta?) {
    MethodReplaceCollection.execute(this, targetRecordIds, collectionAttrName, associatedIds, explicitCbMaybe, meta);
  }
  public validate(attrName, value) {
    MethodValidate.execute(this, attrName, value);
  }
